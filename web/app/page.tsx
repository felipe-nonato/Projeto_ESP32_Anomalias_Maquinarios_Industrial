...
const MapComponent = dynamic(() => import('./components/MapComponent'), {
    ssr: false,
    loading: () => (
        <div className="w-full h-[500px] bg-zinc-200 dark:bg-zinc-800 rounded-lg animate-pulse" />
    ),
})
...
export default function Home(): JSX.Element {
    ...
    const [isDeviceManagerOpen, setIsDeviceManagerOpen] =
        useState<boolean>(false)

    // Configurações do MQTT
    const MQTT_BROKER: string =
        process.env.NEXT_PUBLIC_MQTT_BROKER || 'ws://localhost:9001'
    const MQTT_TOPIC: string =
        process.env.NEXT_PUBLIC_MQTT_TOPIC || 'machines/anomalies'
                            ...
                            <div className="w-full h-[500px] flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-lg">
                                <div className="text-center">
                                    ...
                                    <p className="text-zinc-600 dark:text-zinc-400">
                                        Aguardando dados das máquinas via
                                        MQTT...
                                    </p>
                ...
                <div className="mt-6 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                        <li>
                            ...
                            NEXT_PUBLIC_MQTT_BROKER e NEXT_PUBLIC_MQTT_TOPIC
                        </li>
                        <li>
                            • Os dados são recebidos em tempo real via MQTT do
                            ESP32
                        </li>
                        <li>
                            • Clique nos marcadores do mapa para ver detalhes de
                            cada máquina
                        </li>
                        <li>
